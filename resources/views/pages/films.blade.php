...
<div class="bg-secondary">
    <div class="container mt-3">
        <div class="card bg-dark text-white">
            <div class="row">
                <div class="col-md-4">
                    <img src="img/BD.jpg"class="img-fluid" alt="" style="width: 500px; height: 450px;">
                </div>
                <div class="col-md-6">
                    <h3 class="card-title mt-2 text-center">Movie name</h3>
                    <ul class="card-body">
                        <li class="body-item"> Year :</li>
                        <li class="body-item"> Director :</li>
                        <li class="body-item"> IMDB :</li>
                        <li class="body-item"> Language :</li>
    ...
    <div class="container mt-3">
        <div class="card bg-dark text-white">
            <div class="row">
                <div class="col-md-4">
                    <img src="img/BC.jpg"class="img-fluid" alt="" style="width: 500px; height: 450px;">
                </div>
                <div class="col-md-6">
                    <h3 class="card-title mt-2 text-center">BEAUTY CARE</h3>
                    <ul class="card-body">
                        <li class="body-item"> Year :</li>
                        <li class="body-item"> Director :</li>
                        <li class="body-item"> IMDB :</li>
    ...
    <div class="container mt-3">
        <div class="card bg-dark text-white">
            <div class="row">
                <div class="col-md-4">
                    <img src="img/HC.jpg"class="img-fluid" alt="" style="width: 500px; height: 400px;">
                </div>
                <div class="col-md-6">
                    <h3 class="card-title mt-2 text-center">HAIR CARE</h3>
                    <ul class="card-body">
                        <li class="body-item"> Year :</li>
                        <li class="body-item"> Director :</li>
                        <li class="body-item"> IMDB :</li>
    ...
    <div class="container mt-3">
        <div class="card bg-dark text-white">
            <div class="row">
                <div class="col-md-4">
                    <img src="img/OT.jpg"class="img-fluid" alt="" style="width: 500px; height: 350px;">
                </div>
                <div class="col-md-6">
                    <h3 class="card-title mt-2 text-center">OTHER TREATMENT</h3>
                    <ul class="card-body">
                        <li class="body-item"> Year :</li>
                        <li class="body-item"> Director :</li>
                        <li class="body-item"> IMDB :</li>
